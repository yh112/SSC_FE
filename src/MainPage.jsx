...
function MainPage() {
    ...
    const addUser = async () => {
        try {
            const res = await API.post(`/${teamName}/add/${newUserName}`);
    ...
    return (
        ...
        kr={modalType === 'team' ? '팀명' : modalType === 'project' ? '프로젝트명' : '팀원명'}
        en={modalType === 'team' ? 'Team Name' : modalType === 'project'? 'Project Name' : 'User Name'}
        value={modalType === 'team' ? newTeamName : modalType === 'project' ? newProjectName : newUserName}
        name={modalType === 'team' ? 'newTeamName' : modalType === 'project' ? 'newProjectName' : 'newUserName'}
        active={active}
        onChange={handleInputChange}
        onClick={modalType === 'team' ? addTeam : modalType === 'project' ? createProject : addUser}
      />
